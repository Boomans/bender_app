...
class MapView: UIScrollView {
    ...
    fileprivate func initialize() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(MapView.changeOrientationNotification), name: Notification.Name.UIDeviceOrientationDidChange, object: nil)
    }
    ...
    open func display(image: UIImage) {
        ...
        let tapGesture = UITapGestureRecognizer(target: self, action: #selector(MapView.doubleTapGestureRecognizer(_:)))
    ...
    @objc func doubleTapGestureRecognizer(_ gestureRecognizer: UIGestureRecognizer) {
        ...
        if zoomScale >= maximumZoomScale / 2.0 {
            ...
            let zoomRect = zoomRectForScale(MapView.kZoomInFactorFromMinWhenDoubleTap * minimumZoomScale, center: center)
